...
FIND_PATH(PC_LINT_DIR lint-nt.exe)
set(PC_LINT_EXECUTABLE "${PC_LINT_DIR}/lint-nt.exe" CACHE STRING "full path to the pc-lint executable. NOT the generated lin.bat")
set(PC_LINT_CONFIG_DIR "${PC_LINT_DIR}/lnt" CACHE STRING "full path to the directory containing pc-lint configuration files")
...
if(PC_LINT_DIR)
    ...
    function(add_pc_lint target)
    endfunction(add_pc_lint target)
endif(PC_LINT_DIR)
