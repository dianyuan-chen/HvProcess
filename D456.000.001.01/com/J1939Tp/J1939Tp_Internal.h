...
#define PGN_BYTE_COUNT          3U
/** Service Ids */
#define J1939TP_TRANSMIT_ID     0x05U
#define J1939TP_INIT_ID         0x01U

/** Error Codes */
#define J1939TP_E_PARAM_ID      0x01U
#define J1939TP_E_UNINIT        0x20U
#define J1939TP_E_REINIT        0x21U

#define J1939TP_PACKET_SIZE     7U
...
static inline void J1939Tp_Internal_RxIndication_Dt(const PduInfoType* PduInfoPtr, const J1939Tp_Internal_ChannelInfoType* Channel);
static inline void J1939Tp_Internal_RxIndication_Cm(const PduInfoType* PduInfoPtr, const J1939Tp_Internal_ChannelInfoType* Channel);
static inline void J1939Tp_Internal_RxIndication_ReverseCm(const PduInfoType* PduInfoPtr, const J1939Tp_Internal_ChannelInfoType* Channel);
static inline void J1939Tp_Internal_RxIndication_Direct(const PduInfoType* PduInfoPtr, const J1939Tp_RxPduInfoType* RxPduInfoPtr);
Std_ReturnType J1939Tp_ChangeParameterRequest(PduIdType SduId, TPParameterType Parameter, uint16 value);
static inline void J1939Tp_Internal_TxConfirmation_RxChannel(const J1939Tp_Internal_ChannelInfoType* ChannelInfoPtr, const J1939Tp_RxPduInfoType* RxPduInfo);
...
static inline boolean J1939Tp_Internal_IsLastDt(const J1939Tp_Internal_RxChannelInfoType* rxPgInfo);
static inline void J1939Tp_Internal_TxConfirmation_TxChannel(const J1939Tp_Internal_ChannelInfoType* ChannelInfoPtr,const J1939Tp_RxPduInfoType* RxPduInfo);
static inline boolean J1939Tp_Internal_IsLastDtBeforeNextCts(const J1939Tp_Internal_RxChannelInfoType* rxChannelInfo);

static inline uint16 J1939Tp_Internal_GetRtsMessageSize(const PduInfoType* pduInfo);
static inline boolean J1939Tp_Internal_WaitForCts(const J1939Tp_Internal_TxChannelInfoType* TxChannelState);
static inline boolean J1939Tp_Internal_LastDtSent(const J1939Tp_Internal_TxChannelInfoType* TxPgState);
...
static inline uint8 J1939Tp_Internal_GetDtDataSize(uint8 currentSeqNum, uint16 totalSize);

static inline Std_ReturnType J1939Tp_Internal_SendBam(const J1939Tp_Internal_ChannelInfoType* ChannelInfoPtr,const PduInfoType* TxInfoPtr);
static inline Std_ReturnType J1939Tp_Internal_SendDt(const J1939Tp_Internal_ChannelInfoType* Channel);
static inline Std_ReturnType J1939Tp_Internal_SendRts(const J1939Tp_Internal_ChannelInfoType* ChannelInfoPtr, const PduInfoType* TxInfoPtr, uint8 MaxNumPackets);
static inline void J1939Tp_Internal_SendEndOfMsgAck(const J1939Tp_Internal_ChannelInfoType* Channel);
static inline void J1939Tp_Internal_SendCts(const J1939Tp_Internal_ChannelInfoType* ChannelInfoPtr, J1939Tp_PgnType Pgn, uint8 NextPacketSeqNum,uint8 NumPackets);
static inline void J1939Tp_Internal_SendConnectionAbort(const J1939Tp_Internal_ChannelInfoType* ChannelInfoPtr, J1939Tp_RxPduType packetType, J1939Tp_PgnType Pgn, uint8 Reason);
...
static inline J1939Tp_PgnType J1939Tp_Internal_GetPgn(const uint8 PgnBytes[3]);
...
static void J1939Tp_Internal_Set_Channel_Metadata(J1939Tp_Internal_ChannelInfoType* channelInfo, const uint8 metadata[], uint8 metadatalength);
static inline void J1939Tp_Internal_Copy_Channel_Metadata(const J1939Tp_Internal_ChannelInfoType* channelInfo, uint8 metadata[METADATALENGTH_MAX], uint8 metadatalength);
static Std_ReturnType J1939Tp_Internal_Filter_RxPdu_Metadata
(PduIdType RxPduId, const PduInfoType* PduInfoPtr, J1939Tp_RxPduType packetType, J1939Tp_Internal_ChannelInfoType* channel);
...
static boolean J1939Tp_Internal_Metadata_Matches_Channel(const uint8 metadata[], uint8 metadatalength, J1939Tp_RxPduType packetType, const J1939Tp_Internal_ChannelInfoType* channel);
