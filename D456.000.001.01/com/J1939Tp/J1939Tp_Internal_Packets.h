...
#define DIRECT_TRANSMIT_SIZE                8u
...
#define CM_PGN_VALUE_1                      0x00u
#define CM_PGN_VALUE_2                      0xECu
#define CM_PGN_VALUE_3                      0x00u
 ...
 */
#define CM_PGN_BYTE_1                       5u /* least significant byte */
#define CM_PGN_BYTE_2                       6u
#define CM_PGN_BYTE_3                       7u /* most significant byte of the PGN*/
...
#define CTS_BYTE_NUM_PACKETS                1u

/** @brief Next expected packet number. */
#define CTS_BYTE_NEXT_PACKET                2u

/** @brief Reserved byte index. Must be filled with 0xFF. */
#define CTS_BYTE_SAE_ASSIGN_1               3u

/** @brief Reserved byte index. Must be filled with 0xFF. */
#define CTS_BYTE_SAE_ASSIGN_2               4u
...
#define CTS_START_SEQ_NUM                   1u

/** @brief Command code of the CTS message. */
#define CTS_CONTROL_VALUE                   17u
...
#define RTS_BYTE_LENGTH_1                   1u
#define RTS_BYTE_LENGTH_2                   2u

/** @brief Number of packets (data frames) the sender wants to transmit.*/
#define RTS_BYTE_NUM_PACKETS                3u
...
#define RTS_BYTE_MAX_NUM_PACKETS            4u
...
#define ENDOFMSGACK_BYTE_TOTAL_MSG_SIZE_1   1u

/** @brief MSB of the size of the aknowledged message. */
#define ENDOFMSGACK_BYTE_TOTAL_MSG_SIZE_2   2u

/** @brief Number of acknowledged packets. */
#define ENDOFMSGACK_BYTE_NUM_PACKETS        3u

/** @brief Reserved byte. Should be filled with 0xFF. */
#define ENDOFMSGACK_BYTE_SAE_ASSIGN         4u
 ...
 */
#define ENDOFMSGACK_CONTROL_VALUE           19u
...
#define CONNABORT_BYTE_CONTROL              0u

/** @brief Index of the abort reason. */
#define CONNABORT_BYTE_REASON               1u

/** @brief Reserved index. */
#define CONNABORT_BYTE_SAE_ASSIGN_2         2u
/** @brief Reserved index. */
#define CONNABORT_BYTE_SAE_ASSIGN_3         3u
/** @brief Reserved index. */
#define CONNABORT_BYTE_SAE_ASSIGN_4         4u
...
#define CONNABORT_CONTROL_VALUE             255u
...
#define J1939TP_DT_BROADCAST_MIN_INTERVAL   50u
 ...
 *           V1.3.0, R4.1 Rev 1.
 */
#define J1939TP_TR_TIMEOUT_MS               200u
 ...
 */
#define J1939TP_T4_TIMEOUT_MS               1050u
...
#define DT_PGN_VALUE_1                      0x00u
#define DT_PGN_VALUE_2                      0xEBu
#define DT_PGN_VALUE_3                      0x00u
...
#define DT_DATA_SIZE                        7u

/** @brief Index of the sequence number in TP.DT data. */
#define DT_BYTE_SEQ_NUM                     0u

/* Symbolic values for the indexes of the 7 bytes of data in a TP.DT. */

#define DT_BYTE_DATA_1                      1u
#define DT_BYTE_DATA_2                      2u
#define DT_BYTE_DATA_3                      3u
#define DT_BYTE_DATA_4                      4u
#define DT_BYTE_DATA_5                      5u
#define DT_BYTE_DATA_6                      6u
#define DT_BYTE_DATA_7                      7u
...
#define J1939TP_DEFAULT_PRIORITY            ((uint8)((uint8)7u << 2))
