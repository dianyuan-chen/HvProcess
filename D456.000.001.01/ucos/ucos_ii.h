...
#pragma push
#pragma DATA_SEG __NEAR_SEG UCOS_DATA
...
#define  OS_TCB_RESERVED        ((OS_TCB *__NEAR)1)
...
typedef struct os_tcb {
    OS_STK          *__NEAR OSTCBStkPtr;           /* Pointer to current top of stack                         */
#ifdef __HC12__
    INT8U            RegRPAGE;
#endif
    ...
    struct os_tcb   *__NEAR OSTCBNext;             /* Pointer to next     TCB in the TCB list                 */
    struct os_tcb   *__NEAR OSTCBPrev;             /* Pointer to previous TCB in the TCB list                 */
...
#pragma push
#pragma DATA_SEG __GPAGE_SEG TASK_STACK
OS_EXT  OS_STK            OSTaskIdleStk[OS_TASK_IDLE_STK_SIZE];      /* Idle task stack                */
#pragma pop


OS_EXT  OS_TCB           *__NEAR OSTCBCur;                        /* Pointer to currently running TCB         */
OS_EXT  OS_TCB           *__NEAR OSTCBFreeList;                   /* Pointer to list of free TCBs             */
OS_EXT  OS_TCB           *__NEAR OSTCBHighRdy;                    /* Pointer to highest priority TCB R-to-R   */
OS_EXT  OS_TCB           *__NEAR OSTCBList;                       /* Pointer to doubly linked list of TCBs    */
OS_EXT  OS_TCB           *__NEAR OSTCBPrioTbl[OS_LOWEST_PRIO + 1];/* Table of pointers to created TCBs        */
