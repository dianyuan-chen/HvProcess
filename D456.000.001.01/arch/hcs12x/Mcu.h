...
#define MCU_AR_MINOR_VERSION        2U
#define MCU_AR_PATCH_VERSION        2U
...
/** @name Service id's */
//@{
#define MCU_INIT_SERVICE_ID                 0x00U
#define MCU_INITRAMSECTION_SERVICE_ID       0x01U
#define MCU_INITCLOCK_SERVICE_ID            0x02U
#define MCU_DISTRIBUTEPLLCLOCK_SERVICE_ID   0x03U
#define MCU_GETPLLSTATUS_SERVICE_ID         0x04U
#define MCU_GETRESETREASON_SERVICE_ID       0x05U
#define MCU_GETRESETRAWVALUE_SERVICE_ID     0x06U
#define MCU_PERFORMRESET_SERVICE_ID         0x07U
#define MCU_SETMODE_SERVICE_ID              0x08U
#define MCU_GETVERSIONINFO_SERVICE_ID       0x09U
#define MCU_INTCVECTORINSTALL_SERVICE_ID    0x0AU // Not in spec but follows pattern
//@}
...
#define MCU_GETRESETRAWVALUE_NORESETREG_RV  0x00UL /**< MCU006 */
#define MCU_GETRESETRAWVALUE_UNINIT_RV      0xffffffffUL /**< MCU135 */
...
uint32 McuE_GetPITClock0(void);
uint32 McuE_GetPITClock1(void);
uint32 McuE_GetEtcCloeck(void);
uint32 McuE_GetRandom(void);
