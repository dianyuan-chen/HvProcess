...
#define EEEPROM_DEV_ERROR_DETECT        STD_ON

/**
 * \brief EEEPROM支持的保存参数个数
 */
#define EEEPROM_PARAM_NUM_MAX           512

/**
 * \brief EEEPROM Error define
 */
#define EEEP_ERROR_NONE                 0
#define EEEP_ERROR_NO_PARTITION         1
#define EEEP_ERROR_ERPART               2
#define EEEP_ERROR_DFPART               3
#define EEEP_ERROR_DEAD_SECTOR          4
#define EEEP_ERROR_READY_SECTOR         5
#define EEEP_ERROR_ENABLE_EMULATION     6

/**
 * \brief bit masks for FTM FSTAT
 */
#define EEEP_FTM_MGSTAT0                0x01
#define EEEP_FTM_MGSTAT1                0x02
#define EEEP_FTM_MGBUSY                 0x08
#define EEEP_FTM_FPVIOL                 0x10
#define EEEP_FTM_ACCERR                 0x20
#define EEEP_FTM_CCIF                   0x80

/**
 * \brief bit masks for FTM FERSTAT
 */
#define EEEP_FTM_SFDIF                  0x01
#define EEEP_FTM_DFDIF                  0x02
#define EEEP_FTM_ERSVIF0                0x04
#define EEEP_FTM_ERSVIF1                0x08
#define EEEP_FTM_EPVIOLIF               0x10
#define EEEP_FTM_PGMERIF                0x40
#define EEEP_FTM_ERSERIF                0x80
